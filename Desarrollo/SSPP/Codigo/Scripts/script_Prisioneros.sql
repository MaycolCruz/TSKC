...
iNSERT INTO Conducta VALUES (1,'Buena conducta','Cumple con las reglas y normas de la prisi�n')
...
iNSERT INTO Crimen VALUES (2,'Agresion','Causar da�o f�sico o amenazar con hacerlo a otra persona intencionalmente.')
iNSERT INTO Crimen VALUES (3,'Homicidio','Matar a otra persona de manera intencional (homicidio intencional) o sin intenci�n de causar la muerte (homicidio involuntario).')
iNSERT INTO Crimen VALUES (4,'Trafico de drogas','La producci�n, distribuci�n, venta o transporte ilegal de sustancias controladas, como drogas ilegales.')
iNSERT INTO Crimen VALUES (5,'Fraude','Actividades enga�osas realizadas para obtener beneficios financieros o personales de manera deshonesta, como estafas o falsificaci�n de documentos.')
